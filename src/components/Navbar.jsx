    ...
    <>
      ...
      <nav className="bg-white shadow-sm border-b border-orange-100 sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <Link to="/cart" className="relative flex items-center gap-1.5 px-3 py-2 rounded-xl text-gray-600 hover:bg-orange-50 hover:text-orange-600 transition-colors font-medium text-sm">
          ...
          <div className="flex items-center gap-2">
            <button onClick={toggleLang} className="flex items-center gap-1 px-3 py-2 rounded-xl text-gray-600 hover:bg-orange-50 hover:text-orange-600 transition-colors text-sm font-semibold">
              <Globe size={16}/><span>{lang === 'en' ? 'සිං' : 'EN'}</span>
            </button>
            <button onClick={handleLogout} className="hidden md:flex items-center gap-1.5 px-3 py-2 rounded-xl text-gray-600 hover:bg-red-50 hover:text-red-500 transition-colors text-sm font-medium">
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-orange-100 z-50 shadow-lg">
        <div className="flex items-center justify-around h-16">
          ...
          <Link to="/cart" className="flex flex-col items-center gap-0.5 text-gray-500 px-3 py-1 relative">
          ...
          <button onClick={handleLogout} className="flex flex-col items-center gap-0.5 text-gray-500 px-3 py-1">
